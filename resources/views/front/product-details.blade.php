                ...
                <div class="product-details-img owl-carousel owl-theme">
                    ...
                    <div class="item">
                        ...
                        <a data-fancybox="gallery" href="{{$images->image }}">
                              ...
                              <img src="{{ asset('images/item/' . $images->image) }}" alt="">
                ...
                <div class="pro-details-name-wrap">
                    ...
                    @if (Session::get('id'))
                        ...
                        @else
                            ...
                            <i class="fa fa-heart i" onclick="MakeFavorite('{{$getitem->id}}','{{Session::get('id')}}')"></i>

                        @endif

                    @else

                        <a class="i" href="{{URL::to('/signin')}}"><i class="fa fa-heart i"></i></a>
                    ...
                    <div class="ingredients-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            ...
                            <div class="ingredients-box">
                                ...
                                <img src="{{ asset('images/ingredients/' . $ingredients->image) }}" alt="">
                        ...
                        <div class="pro-box">
                            ...
                            <div class="pro-img">
                                ...
                                @else
                                    ...
                                    <a href="{{URL::to('/signin')}}"><i class="fa fa-heart i"></i></a>
