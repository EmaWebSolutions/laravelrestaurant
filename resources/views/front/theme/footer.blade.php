...
<footer>
	...
	<div class="container d-flex justify-content-between flex-wrap">
		...
		<div class="footer-head">
			...
			<div class="footer-logo"><img src='{!! asset("images/about/logo.png") !!}' alt=""></div>
	...
	<div class="copy-right text-center">
		...
		<p>{{$getabout->copyright}} <br> Designed & Developed by <a href="https://infotechgravity.com" target="_blank" style="color: #000;"><b>Ema Web Solutions</b>.</a></p>
