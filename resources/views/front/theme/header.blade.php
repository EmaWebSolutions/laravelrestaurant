...
<head>
	...
	<link rel="icon" href='{!! asset("images/about/logo.png") !!}' type="image/x-icon">
	...
	********************-->
	...
	<div id="preloader" style="display: none;">
	    ...
	    <div class="loader">
	        ...
	        <img src="{!! asset('images/delivery/delivery2.gif') !!}">
	...
	<header>
		...
		<nav class="navbar navbar-expand-lg">
			...
			<div class="container">
				...
				<a class="navbar-brand" href="{{URL::to('/')}}"><img src='{!! asset("images/about/logo.png") !!}' alt=""></a>
					...
					<ul class="navbar-nav">
						...
						@if (Session::get('id'))
							...
							<li class="nav-item {{ request()->is('favorite') ? 'active' : '' }}">
								...
								<a class="nav-link" href="{{URL::to('/favorite')}}">Favourite </a>

							</li>

							<li class="nav-item {{ request()->is('wallet') ? 'active' : '' }}">

								<a class="nav-link" href="{{URL::to('/wallet')}}">Wallet</a>
