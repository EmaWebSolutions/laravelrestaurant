    ...
    <div class="container-fluid mt-3">
        <div class="row">
              <div class="col-lg-3 col-sm-6">
                <div class="cardinal-3">
                    <a href="{{URL::to('/admin/item')}}">
                        <div class="card-body">
                            <h3 class="card-title text-white">Items</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($getitems) ? count($getitems) : ''}}</h2>
                            </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="cardinal-2">
                    <a href="{{URL::to('/admin/category')}}">
                        <div class="card-body">
                            <h3 class="card-title text-white">Categories</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($getcategory) ? count($getcategory) : ''}}</h2>
                ...
                <div class="cardinal">
                    <a href="{{URL::to('/admin/users')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($getusers) ? count($getusers) : ''}}</h2>
                            </div>
                ...
                <div class="cardinal-2">
                    <a href="{{URL::to('/admin/addons')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($addons) ? count($addons) : ''}}</h2>
                            </div>
                ...
                <div class="cardinal">
                    <a href="{{URL::to('/admin/reviews')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($getreviews) ? count($getreviews) : ''}}</h2>
                            </div>
                ...
                <div class="cardinal-3">
                    <a href="{{URL::to('/admin/orders')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($getorders) ? count($getorders) : ''}}</h2>
                            </div>
                ...
                <div class="cardinal-2">
                    <a href="{{URL::to('/admin/promocode')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($getpromocode) ? count($getpromocode) : ''}}</h2>
                            </div>
                ...
                <div class="cardinal-3">
                    <a href="{{URL::to('/admin/banner')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($banners) ? count($banners) : ''}}</h2>
                            </div>
